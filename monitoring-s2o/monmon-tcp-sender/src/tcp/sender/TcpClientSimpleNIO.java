package es.s2o.monmon.tcp.sender;
 ...
 * 
 */
public abstract class TcpClientSimpleNIO implements Runnable {
	// protected static final Logger LOG = Logger.getLogger(TcpClientSimpleNIO.class);
	...
	public static void main(String[] args) throws Exception {
		...
		// "%d{yyyyMMdd-HH:mm:ss} %-10t %-5p %-20C{1} - %m%n")));
		// Logger.getRootLogger().setLevel(Level.INFO);
		final TcpClientSimpleNIO client = new TcpClientSimpleNIO() {
			@Override
