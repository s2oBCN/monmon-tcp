...
import es.s2o.monmon.tcp.remoting.Connector;
import es.s2o.monmon.tcp.remoting.ConnectorFactory;
...
public class NettyConnectorFactory implements ConnectorFactory {
	public Connector createConnector(final Map<String, Object> configuration, final BufferHandler handler,
