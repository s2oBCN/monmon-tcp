...
public interface ConnectionLifeCycleListener {
	 ...
	 * for a reasonable split between the hornetq-server and hornetq-client packages while avoiding to pull too much
	 * into hornetq-core. The pivotal point keeping us from removing the method is {@link ConnectorFactory} and the
	 * usage of it.
