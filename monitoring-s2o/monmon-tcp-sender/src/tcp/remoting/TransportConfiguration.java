...
public class TransportConfiguration implements Serializable {
	 ...
	 * {@link org.hornetq.spi.core.remoting.ConnectorFactory} and any parameters needed.
	 * 
	...
	/**
	 * Creates a TransportConfiguration providing the class name of the
	 * {@link org.hornetq.spi.core.remoting.ConnectorFactory}
	 * 
	 * @param className The class name of the ConnectorFactory
	 */
	...
	/**
	 * There's a case on ClusterConnections that we need to find an equivalent Connector and we can't use a Netty
	 * Cluster Connection on an InVM ClusterConnection (inVM used on tests) for that reason I need to test if the two
	 * instances of the TransportConfiguration are equivalent while a test a connector against an acceptor
	 * @param otherConfig
